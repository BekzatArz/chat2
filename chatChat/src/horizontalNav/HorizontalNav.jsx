   ...
   return(
      <>
         <div className="hnav">
            <div className="tabs">
               <p
                  className={clikedHome ===true? `clik` : `n`}
                   onclick={clickHome}>
                  Дом 
               </p>
               <p className={clikedNotification ===true? `clik` : `n`} onClick={clickNotification}> Уведовление</p>
               <p className={clikedMarket ===true? `clik` : `n`} onClick={clickMarket}>Рыночная площадь</p>
               <p className={clikedGroups ===true? `clik` : `n`} onClick={clickGroups}>Группы</p>
               <p className={clikedLive ===true? `clik` : `n`} onClick={clickLive}>Прямой Эфир</p>
            </div>
            <CiSearch
               size={30}
               className="search"
