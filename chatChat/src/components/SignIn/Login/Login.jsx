    ...
    <div className='sign-in'>
      ...
      <div className="regis">
          ...
          <form action="#" className='regis-form'>
            ...
            <input className='regis-form__input' type="email" id='email'/>
            <label htmlFor="pass">Password</label>
            <input className='regis-form__input'id='pass' type="password" />
            <div className="regis-submit">
              ...
              <button className='regis__btn'>Войти</button>
            </div>
          </form>
          <h5 className="sign-link">
            <NavLink to='/registration'>
               Ещё нет аккаунта? ПЕРЕХОДИТЕ ПРЯМО СЕЙЧАС
            </NavLink>
          </h5>
      </div>
    </div>
